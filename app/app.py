...
app.add_page(
    admin_dashboard,
    route="/admin",
    on_load=[AdminState.check_auth, AdminState.load_reservations],
)
app.add_page(admin_services, route="/admin/servicios", on_load=AdminState.check_auth)
app.add_page(admin_barbers, route="/admin/barberos", on_load=AdminState.check_auth)
app.add_page(
    admin_analytics,
    route="/admin/analytics",
    on_load=[AdminState.check_auth, AdminState.load_analytics],
)